describe("Banjo - Social. LinkedIn. Send a Photo (Landscape).", function() {
...
//---------------------------------------
it("LINKEDIN.POST.PHOTO", function() {
	UIALogger.logStart("LINKEDIN.POST.PHOTO");
	...
	if (Win.scrollViews()[0].buttons()[4].checkIsValid()) {
		UIALogger.logPass("LINKEDIN.POST.PHOTO PASSED");
	}
	else {
		UIALogger.logFail("LINKEDIN.POST.PHOTO FAILED");
		throw new Error("LINKEDIN.POST.PHOTO FAILED");
	}
