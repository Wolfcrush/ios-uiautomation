describe("Banjo - Edit Profile.", function() {
...
it("SAVE.PROFILE.BLANK", function() {
	...
	Win.tableViews()[0].cells().firstWithPredicate("name contains[c] '"+user1_name+"'").buttons()[6].tap();
...
it("SAVE.PROFILE.NAME", function() {
	...
	Win.tableViews()[0].cells().firstWithPredicate("name contains[c] 'New Name'").buttons()[6].tap();
	Wait(Win.scrollViews()[0].buttons()[0]);
