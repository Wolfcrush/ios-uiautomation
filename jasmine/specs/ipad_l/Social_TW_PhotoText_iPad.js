describe("Banjo - Social. Twitter. Send a Photo & Text (Landscape).", function() {
...
//---------------------------------------
it("TWITTER.POST.PHOTO&TEXT", function() {
	UIALogger.logStart("TWITTER.POST.PHOTO&TEXT");
	...
	if (Win.scrollViews()[0].buttons()[4].checkIsValid()) {
		UIALogger.logPass("TWITTER.POST.PHOTO&TEXT PASSED");
	}
	else {
		UIALogger.logFail("TWITTER.POST.PHOTO&TEXT FAILED");
		throw new Error("TWITTER.POST.PHOTO&TEXT PASSED");
	}
