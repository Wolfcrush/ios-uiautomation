describe("Banjo - Social. Facebook. Send a Photo (Landscape).", function() {
...
//---------------------------------------
it("FACEBOOK.POST.PHOTO", function() {
	...
	if (Win.scrollViews()[0].buttons()[4].checkIsValid()) {
		UIALogger.logPass("FACEBOOK.POST.PHOTO PASSED");
	}
	else {
		UIALogger.logFail("FACEBOOK.POST.PHOTO FAILED");
		throw new Error("FACEBOOK.POST.PHOTO FAILED");
	}
